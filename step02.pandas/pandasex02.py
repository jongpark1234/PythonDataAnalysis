...
print(ex01.city[(ex01.city > 2000000) & (ex01.city < 4000000)]) # 값이 2000000 초과, 4000000 미만인 요소들만 가져옴.


# 인덱스 라벨을 사용하여 value에 접근하는 방법. dot 이용

a = pd.Series(range(3), index=['가', 'b', 'c'])
print(a.가) # <=> a['가']
